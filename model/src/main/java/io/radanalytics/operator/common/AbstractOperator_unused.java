 ...
 */
public abstract class AbstractOperator_unused<T extends EntityInfo> {

    protected static final Logger log = LoggerFactory.getLogger(AbstractOperator_unused.class.getName());
    ...
    public AbstractOperator_unused() {
    ...
    protected T convertCr(InfoClass info) {
        ...
        log.info("Converting new resource - source" + info);
        ...
        log.info("Converting new resource - result" + infoSpec);
        return infoSpec;
    }
